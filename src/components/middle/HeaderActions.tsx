...
const HeaderActions: FC<OwnProps & StateProps> = ({
  ...
  const getTextWithLanguage = useLastCallback(
  ...
  const handleOperatorsClick = useLastCallback(() => {
    requestNextManagementScreen({ screen: ManagementScreens.GroupMembers });
  });
  // requestNextManagementScreen({ screen: ManagementScreens.GroupMembers });
  ...
  return (
    <div className="HeaderActions">
      ...
      {!isMobile && (
        <>
          ...
          {canExpandActions && canStartBot && (
            <Button size="tiny" ripple fluid onClick={handleStartBot}>
              {lang("BotStart")}
            </Button>
          )}
      ...
      >
        <i className="icon icon-group" aria-hidden />
      </Button>
      {menuPosition && (
        <HeaderMenuContainer
          chatId={chatId}
